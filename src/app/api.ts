...
export const getEvents = (id?: string) => axiosInstance.get("/events/", {params: {creativx: id}});
...
export const makeEdition = (data: {title: string, covers: Array<{url: string, color: string}>}) => {
...
export const addToEditionGallery = (id: string, data: {
    url:string;
    title: string;
    author: string;
    section: string;
...
export const deleteCreativx = (id: string) => axiosInstance.delete(`/creativx/${id}`);

export const getLocations = () => axiosInstance.get("/locations/");

export const getStates = () => axiosInstance.get("/locations/state");

export const makeLocation = (data: {name: string, address: string, zipCode: string, coords: string, state: string}) => {
